...
export default function TechnicianScreen() {
  ...
  const categoryInfo = getCategoryInfo('technician');
  const allServices = getServicesByCategory('technician');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              ...
              <ThemedText style={styles.headerTitle}>Technician</ThemedText>
            </View>

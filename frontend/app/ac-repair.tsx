...
export default function ACRepairScreen() {
  ...
  const categoryInfo = getCategoryInfo('ac-repair');
  const allServices = getServicesByCategory('ac-repair');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Ionicons name="snow-outline" size={24} color="#fff" style={styles.headerIcon} />
              <ThemedText style={styles.headerTitle}>AC Repair</ThemedText>
            </View>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={styles.searchInputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Search ac repair services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for ac repair services
                      </ThemedText>
                    </View>
                  )}
                </View>

...
export default function ElectricianScreen() {
  ...
  const categoryInfo = getCategoryInfo('electrician');
  const allServices = getServicesByCategory('electrician');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Ionicons name="flash-outline" size={24} color="#fff" style={styles.headerIcon} />
              <ThemedText style={styles.headerTitle}>Electrician</ThemedText>
            </View>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={styles.searchInputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Search electrician services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for electrician services
                      </ThemedText>
                    </View>
                  )}
                </View>

...
export default function CleanerScreen() {
  ...
  const categoryInfo = getCategoryInfo('cleaner');
  const allServices = getServicesByCategory('cleaner');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Ionicons name="sparkles-outline" size={24} color="#fff" style={styles.headerIcon} />
              <ThemedText style={styles.headerTitle}>Cleaner</ThemedText>
            </View>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={styles.searchInputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Search cleaner services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for cleaner services
                      </ThemedText>
                    </View>
                  )}
                </View>

...
export default function MasonScreen() {
  const { theme } = useTheme();
  
  const categoryInfo = getCategoryInfo('mason');
  const allServices = getServicesByCategory('mason');
    ...
    <ThemedView style={styles.container}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={[styles.header, { backgroundColor: theme.tint }]}>
          ...
          <ThemedText type="title" style={[styles.headerTitle, { color: '#fff' }]}>Mason</ThemedText>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={[styles.searchInputContainer, { backgroundColor: theme.inputBackground, borderColor: theme.inputBorder }]}>
                ...
                <TextInput
                  ...
                  placeholder="Search mason services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for mason services
                      </ThemedText>
                    </View>
                  )}
                </View>

...
export default function MechanicScreen() {
  ...
  const categoryInfo = getCategoryInfo('mechanic');
  const allServices = getServicesByCategory('mechanic');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Ionicons name="construct-outline" size={24} color="#fff" style={styles.headerIcon} />
              <ThemedText style={styles.headerTitle}>Mechanic</ThemedText>
            </View>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={styles.searchInputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Search mechanic services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for mechanic services
                      </ThemedText>
                    </View>
                  )}
                </View>

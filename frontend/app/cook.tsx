...
export default function CookScreen() {
  ...
  const categoryInfo = getCategoryInfo('cook');
  const allServices = getServicesByCategory('cook');
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <Ionicons name="restaurant-outline" size={24} color="#fff" style={styles.headerIcon} />
              <ThemedText style={styles.headerTitle}>Cook</ThemedText>
            </View>
            ...
            <SafeAreaView style={styles.searchSafe}>
              ...
              <View style={styles.searchInputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Search cook services..."
                  value={searchQuery}
                  ...
                  {filteredServices.length > 0 ? (
                    ...
                    <View style={styles.searchHintContainer}>
                      ...
                      <ThemedText style={styles.searchHintText}>
                        Start typing to search for cook services
                      </ThemedText>
                    </View>
                  )}
                </View>

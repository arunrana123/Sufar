...
export default function PlumberScreen() {
  ...
  const categoryInfo = getCategoryInfo('plumber');
  const allServices = getServicesByCategory('plumber');
  ...
  // Service cards now have their own Book and View buttons
  // No need for the old onPress functionality

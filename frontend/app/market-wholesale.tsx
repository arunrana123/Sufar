// WHOLESALE MARKET SCREEN - View all wholesale products
...
export default function WholesaleMarketScreen() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/api/market/products?category=Wholesale`);
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            {filteredProducts.length > 0 ? (
              ...
              <View style={styles.emptyContainer}>
                <Ionicons name="storefront-outline" size={64} color={theme.icon} />

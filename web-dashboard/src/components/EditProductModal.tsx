  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        discount: formData.discount ? parseFloat(formData.discount as any) : undefined,
        rating: formData.rating ? parseFloat(formData.rating as any) : 0,
        reviewCount: formData.reviewCount ? parseInt(formData.reviewCount as any) : 0,
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto m-4">
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Same form fields as ProductFormModal */}
